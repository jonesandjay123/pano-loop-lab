...
export const PANO_RING: PanoRingConfig = {
  ...
  seams: [
    ...
    },
    {
      ...
      imageUrl: "/panos/adapters-clean/dusk-ridge__moonlit-tidelands-photoshop-test2.png",
      ...AXB_SOCKET,
      notes: "Filled BXC from Photoshop test 2.",
    },
    {
      fromId: "moonlit-tidelands",
      toId: "dawn-valley",
      imageUrl: "/panos/adapters-clean/moonlit-tidelands__dawn-valley-photoshop-test3.png",
      ...AXB_SOCKET,
      notes: "Filled CXA from Photoshop test 3.",
    },
  ],
